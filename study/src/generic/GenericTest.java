...
public class GenericTest {
    public static void main(String[] args) {
        ...
        list.add("홍길동"); //String --> Object 형변환 되어 들어감
        ...
        //Object(큰 개념) --> String(작은 개념) : 강제 형변환

        //제너릭을 썼을 때 : 객체 생성 시 내가 정한 타입으로 설정할 수 있음
        ArrayList<String> list2 = new ArrayList<>(); //String으로 타입 설정
        list2.add("김길동");
        System.out.println(list2.get(0).charAt(0));

        ArrayList<Integer> list3 = new ArrayList<>(); //Integer로 설정(int로 박싱/언박싱 가능)
